...
public class varTrial {
		...
		public static void main(String[] args) {
			...
			//multiple variable
			String strV1, strV2, strV3;
			strV1 = strV2 = strV3 = "initialised";
			System.out.println("strV1 = " + strV1);
			System.out.println("strV2 = " + strV2);
			System.out.println("strV3 = " + strV3);

			String str1 = "Hello ";
			String str2 = "World";
			String printStr = " "; //			System.out.println("strV1 = " + strV1);
			...
			//Multiplication
			doubleAnswer = doubleNum2 * doubleNum3;
			System.out.println(doubleNum2 + " * " + doubleNum3 + " = " + doubleAnswer);
			
			//Division 1
			doubleAnswer = doubleNum1 / doubleNum2;
			System.out.println(doubleNum2 + " / " + doubleNum2 + " = " + doubleAnswer);
			...
			System.out.println(intNum1 + " / " + (int)doubleNum2 + " = " + doubleAnswer);
			
			doubleAnswer = (double) intNum1 / doubleNum2;
			System.out.println((double) intNum1 + " / " + doubleNum2 + " = " + doubleAnswer);
